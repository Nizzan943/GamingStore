...
namespace GamingStore.Data
{
    public class SeedData
    {
        ...
        //        new Item
        //        {
        //            Title = "NVIDIA GeForce RTX 3090", Brand = "NVIDIA", Price = 1500, Category = "GPUs",
        //            PropertiesList = new Dictionary<string, string>()
        //            {
        //                {"Cooling System", "Fan"},
        ...
        //            Category = "CPUs", PropertiesList = new Dictionary<string, string>()
        //            {
        //                {"Cores", "10"},
        ...
        //            Category = "Monitors", PropertiesList = new Dictionary<string, string>()
        //            {
        ...
        //            Category = "Keyboards", PropertiesList = new Dictionary<string, string>()
        //            {
        ...
        //            Category = "Mouses", PropertiesList = new Dictionary<string, string>()
        //            {
